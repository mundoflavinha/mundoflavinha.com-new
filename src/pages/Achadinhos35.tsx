...
import pegaPompom from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-pegapompom.webp";
import livroSensorialMontessori from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-placademontessorisensorial.webp";
import quadroMagnetico from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-quadrodedesenhomagnetico.webp";
import tangram from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-tangram.webp";
import livroSensorialGirafa from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-placasensorialgirafa.webp";
import jogoPescaria from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-pegapeixe.webp";
import equiliTetris from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-tetris.webp";
import escavadeiraInfantil from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-tratorate50kg.webp";
import quebraCabecaDinossauros from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-quebracabecadinossauro.webp";
import quebraCabecaArca from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-quebracabecaarcadenoe.webp";
import laptopMadeira from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-laptopdemadeiraeducativo.webp";
import laptopPatrulha from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-laptopinfantil.webp";
import legoClassic from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-legoclassicmaletadeconstrucao.webp";
import livroInterativoBilingue from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-livrointerativobilingue.webp";
import livroInterativoSemTela from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-livrointerativosemtela.webp";
import livroMagneticoAnimais from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-livromagnetico40peças.webp";
import playDohCorteMaluco from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-massinhacortemaluco.webp";
import mesinhaProjetora from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-mesinhaprojetora.webp";
import primeiroTabuleiro from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-meuprimeirotabuleiro.webp";
import separandoCores from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-montessorimagneticocontarcoresenumeros.webp";
import kitLetrasNumerosFormas from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-3tabuleiroseducativos.webp";
import acheEncaixeSinto from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-acheeencaixecomomesinto.webp";
import bicicletaBuba from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-bicicletabuba.webp";
import bingoAnimais from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-bingodosanimais.webp";
import blocosMagneticos from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-blocodeconstruçãomagnetico.webp";
import mesaMontarBlocos from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-blocomontarcommesa.webp";
import brincandoEngenheiro from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-brincandodeengenheiro73peças.webp";
import montaBichinhos from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-brinquedodemontarbrinchinho.webp";
import cabecaBatata from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-cabecadebatata.webp";
import caiuPerdeu from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-caiuperdeu.webp";
import canetinhasLavaveis from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-canetinhaslavaveis.webp";
import cartoesEducativos from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-cartoeseducativosingleseportugues.webp";
import cuboEmocoes from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-cubodasemocoes.webp";
import descobrindoEmocoes from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-descobrindoasemocoes.webp";
import dominoFrutas from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-dominofrutas.webp";
import formaBichos from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-formasebichos.webp";
import hipopotamosComiloes from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-hipopotamoscomiloes.webp";
import jogoGangorra from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-jogodegangorra.webp";
import jogoSoletrando from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-jogosoletrando.webp";
import kitPinturaPatrulha from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-kitpinturapatrulhacanina.webp";
import montarFuradeira from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Brinquedo Educativo de Montar com Furadeira Elétrica - 106 Peças - 3 a 7 Anos.webp";
import playDohHamburguer from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Massinha de Modelar Infantil, Festa do Hambúrguer.webp";

import memoriaPinosColoridos from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo da Memória em Madeira Com Pinos Coloridos –.webp";
import quebraMuro from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Quebra Muro Infantil – Brinquedo Educativo.webp";
import crocodiloCrocCroc from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Crocodilo Croc Croc BBR Toys.webp";
import equilibraFilhotes from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Equilibra Filhotes Patrulha Canina.webp";
import pinguimNumaFria from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Pinguim Numa Fria Jogo Quebra Gelo.webp";
import pulaMacaco from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Pula Macaco, Estrela.webp";
import puxaPuxaBatatinha from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Puxa Puxa Batatinha, Estrela.webp";
import respondaSePuder from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Responda Se Puder, Estrela.webp";
import matematicaKinderland from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Kinderland Brinquedo Educativo de Matemática para Crianças 2 a 7 Anos.webp";
import kitAdicaoSubtracao from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Kit 2 Placas Educativas de Madeira para Adição e Subtração.webp";
import laboratorioShowLuna from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Laboratório Show da Luna Criativo Infantil Kit com 24 Experimentos.webp";
import jogoEducativoMatematica from "@/assets/achadinho da flavinha/3 a 5 anos/3-5anos-Jogo Educativo de Matematica para crianças,Didatico com Numeros Símbolos e Palitos Coloridos.webp";
