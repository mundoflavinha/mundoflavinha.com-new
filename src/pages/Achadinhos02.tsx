...
import andadorZebra from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-apoiador.jpg";
import baldePrimeirosBlocos from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-baldeprimeirosblocos.jpg";
import bichinhosBanho from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-bichinhoparabanho.jpg";
import blocosSurpresa from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-blocossurpresa.jpg";
import bolaSensorial from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-bola.jpg";
import cachorrinhoInterativo from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-cachorromexe.jpg";
import caixaEncaixe from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-caixaencaixa.jpg";
import chocalhoMordedor from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-chocalhocommordedor.jpg";
import chocalhoBolaFrutas from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-chocalhocommordedorbolafruta.jpg";
import almofadaAtividades from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-almofadadeatividade.jpg";
import controleRemoto from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-controleremoto.jpg";
import mesaEducativa from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-mesaeducativa.jpg";
import pandeiroInfantil from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-pandeiro.jpg";
import forminhasPicole from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-forminhapicole.jpg";
import girafaDidatica from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-girafadidatica.jpg";
import girafaMordedor from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-girafamordedor.jpg";
import livroColorir from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-livrocolorir.jpg";
import cuboEducativo from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-cuboeducativo.jpg";
import cuboGrande from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-cubogrande.jpg";
import chocalhoColorido from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-chocalhocommordedorcolorido.jpg";
import torreEmpilhar from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-torreempilhar.jpg";
import tapeteAgua from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-tapetedeagua.jpg";
import tapeteMusical from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-tapetemusical.jpg";
import tapeteTermico from "@/assets/achadinho da flavinha/0 a 2 anos/0-2anos-tapetetermico.jpg";
