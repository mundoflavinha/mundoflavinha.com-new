...
import { getBrincadeira35BySlug } from "@/data/brincadeiras35";
...
const BrincadeiraDetalhe35 = () => {
  const { slug } = useParams();
  const brincadeira = getBrincadeira35BySlug(slug);

  if (!brincadeira) {
    return <Navigate to="/brincadeiras/3-a-5-anos" replace />;
  }
...
export default BrincadeiraDetalhe35;
