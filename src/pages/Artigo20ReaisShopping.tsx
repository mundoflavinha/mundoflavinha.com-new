...
const Artigo20ReaisShopping = () => (
  <ArtigoLayout
    url={articleUrl}
    title={articleTitle}
    subtitle="Uma experiência simples no shopping virou uma reflexão sobre escolhas, espera, limites e educação financeira infantil na prática."
    category="Reflexão"
    readingTime="4 min de leitura"
    date="30 de maio de 2026"
    heroImage={vinteReais}
    pullQuote={"\"Educação financeira não é sobre falar. É sobre sentir.\""}
    paragraphs={articleParagraphs}
    youtubeUrl="https://youtu.be/6o3T8RqZPPo"
    tags={tags}
    relatedPosts={relatedPosts}
    next={{ to: "/blog", label: "Ver todos os artigos" }}
  />
);
