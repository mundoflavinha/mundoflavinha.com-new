...
import { ArrowRight, Clock, HeartHandshake, Star } from "lucide-react";
import Layout from "@/components/Layout";
import { Button } from "@/components/ui/button";
import { brincadeirasFamilia } from "@/data/brincadeirasFamilia";

const BrincadeirasFamilia = () => {
  return (
    <Layout>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-sm font-heading font-bold text-primary">
              ...
              30 ideias para criar memórias em família
            </span>
            ...
            <p className="mx-auto mt-3 max-w-3xl text-sm leading-relaxed text-muted-foreground md:text-base">
              Para criar memórias, fortalecer vínculos e se divertir juntos. Aqui você encontra brincadeiras simples,
              afetivas e cheias de movimento para reunir crianças e adultos em momentos longe das telas.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pt-6 pb-12 md:pt-8 md:pb-16">
        <div className="container">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {brincadeirasFamilia.map((item, index) => (
              <motion.article
                key={item.slug}
              ...
              >
                <Link to={`/brincadeiras/em-familia/${item.slug}`} className="block">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3">
                    ...
                    <Link to={`/brincadeiras/em-familia/${item.slug}`}>
...
export default BrincadeirasFamilia;
