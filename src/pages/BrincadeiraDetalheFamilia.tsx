...
import { ArrowLeft, Clock, Heart, HeartHandshake, PlayCircle, ShieldAlert, Star } from "lucide-react";
import Layout from "@/components/Layout";
import { Button } from "@/components/ui/button";
import { getBrincadeiraFamiliaBySlug } from "@/data/brincadeirasFamilia";
...
const BrincadeiraDetalheFamilia = () => {
  const { slug } = useParams();
  const brincadeira = getBrincadeiraFamiliaBySlug(slug);

  if (!brincadeira) {
    return <Navigate to="/brincadeiras/em-familia" replace />;
  }
      ...
      <article>
        <section className="bg-pink/15 py-8 md:py-12">
          <div className="container">
            <Link to="/brincadeiras/em-familia">
...
export default BrincadeiraDetalheFamilia;
