        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-sm font-heading font-bold text-primary">
              ...
              24 ideias práticas para brincar em casa
            </span>
            ...
            <p className="mx-auto mt-3 max-w-3xl text-sm leading-relaxed text-muted-foreground md:text-base">
              Atividades para explorar, descobrir e se desenvolver. Nessa fase, o bebê aprende pelo corpo,
              pelo vínculo, pela repetição e pelas pequenas descobertas do dia a dia. Aqui você encontra ideias
              simples para estimular sentidos, coordenação, linguagem, atenção e autonomia.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {brincadeiras02.map((item, index) => (
              ...
              >
                <Link to={`/brincadeiras/0-a-2-anos/${item.slug}`} className="block">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3">
                    ...
                    <Link to={`/brincadeiras/0-a-2-anos/${item.slug}`}>
