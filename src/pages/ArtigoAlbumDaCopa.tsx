...
const ArtigoAlbumDaCopa = () => (
  <ArtigoLayout
    url={articleUrl}
    title={articleTitle}
    subtitle="Entre figurinhas repetidas, pacotinhos e memórias afetivas, entendi que o álbum da Copa vai muito além do consumo. Um texto sobre infância, equilíbrio e experiências em família."
    category="Reflexão"
    readingTime="3 min de leitura"
    date="30 de maio de 2026"
    heroImage={albumDaCopa}
    pullQuote={'"As crianças não precisam ter tudo. Mas também não precisam ficar de fora de tudo."'}
    paragraphs={articleParagraphs}
    youtubeUrl="https://youtu.be/XbKScLm5R5U"
    tags={tags}
    relatedPosts={relatedPosts}
    next={{ to: "/blog/presenca-pequenos-momentos", label: "Presença se constrói nos pequenos momentos" }}
  />
);
