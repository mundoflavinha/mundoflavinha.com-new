...
const ArtigoBrincadeiraNoCarro = () => (
  <ArtigoLayout
    url={articleUrl}
    title={articleTitle}
    subtitle="Uma reflexão sobre como brincadeiras simples no carro podem criar conexão, memórias afetivas e momentos de presença entre pais e filhos."
    category="Reflexão"
    readingTime="3 min de leitura"
    date="30 de maio de 2026"
    heroImage={brincadeiraNoCarro}
    pullQuote={"\"No fim, talvez as crianças nem se lembrem de quantos quilômetros percorremos. Mas provavelmente vão lembrar de como se sentiam durante o caminho.\""}
    paragraphs={articleParagraphs}
    youtubeUrl="https://youtu.be/4bPpf4jUnQY"
    tags={tags}
    relatedPosts={relatedPosts}
    next={{ to: "/blog/20-reais-shopping", label: "Dei R$20 para cada filho meu no shopping" }}
  />
);
